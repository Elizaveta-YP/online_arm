...
const EquipmentItem = ({ request, index, onUpdate, onRemove, onFileChange, onFileRemove }) => {
    ...
    <div className="requestItem">
      ...
      <div className="formGroup">
        <textarea
          ...
          ref={textareaRef}
          placeholder="Опишите оборудование, которое вы забрали"
          required
...
const EquipmentCollection = ({ onClose = () => {} }) => {
