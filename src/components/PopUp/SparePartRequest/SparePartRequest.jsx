    ...
    <div className="formGroup">
      ...
      <div className="formGroup">
        <input
          ...
          placeholder="Номер телефона ответственного"
          required
        />
        <span className="required-star">*</span>
...
const SparePartRequest = ({ onClose }) => {
  ...
  return (
    <div className="sparePartRequest">
      <h2 className="subtitleRequest">Подать заявку на запчасть</h2>
